      ...
      <div className="container-px mx-auto max-w-7xl py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a
                href={settings.instagram_url ?? studioConfig.social.instagram}
                target="_blank"
              ...
              <a
                href={settings.youtube_url ?? studioConfig.social.youtube}
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-ink-600 text-ink-300 transition-colors hover:border-gold-400 hover:text-gold-300"
                aria-label="YouTube"
              ...
              <a
                href={settings.facebook_url ?? studioConfig.social.facebook}
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-ink-600 text-ink-300 transition-colors hover:border-gold-400 hover:text-gold-300"
                aria-label="Facebook"
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3.5">
              <li>
                <a href={`tel:${settings.phone}`} className="flex items-center gap-3 text-sm text-ink-300 transition-colors hover:text-gold-300">
                  <Phone className="h-4 w-4 flex-shrink-0 text-gold-400" strokeWidth={1.5} />
                  {settings.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${settings.email}`} className="flex items-center gap-3 text-sm text-ink-300 transition-colors hover:text-gold-300 break-all">
        ...
        <div className="mt-14 border-t border-ink-700/50 pt-8 text-center">
          <p className="text-sm text-ink-400">
            © 2026 {settings.studio_name}. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
